...
`PRIVATE_JH_V1` keeps G5/G6 as its target band while permitting existing G1–G4 prerequisite/foundation curriculum IDs. It supports secondary Skills, cross-unit work, and the eight assessment-style tags. `COMPETITION_V1` permits G4–G6 curriculum IDs plus an independent Thinking Skill layer. A mapping has one primary Skill, one primary Micro, zero or more secondary Skills, and—only for Competition—one primary and zero or more secondary Thinking Skills.
